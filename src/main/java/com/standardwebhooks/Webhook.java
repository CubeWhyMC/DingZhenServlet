...
public final class Webhook {
    ...
    public void verify(final String payload, final HttpHeaders headers) throws WebhookVerificationException {
        Optional<String> msgId = headers.firstValue(UNBRANDED_MSG_ID_KEY);
        Optional<String> msgSignature = headers.firstValue(UNBRANDED_MSG_SIGNATURE_KEY);
        Optional<String> msgTimestamp = headers.firstValue(UNBRANDED_MSG_TIMESTAMP_KEY);
